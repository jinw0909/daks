...
class SpeakerApplication(Base, TimestampMixin):
    ...
    presentation_content: Mapped[str] = mapped_column(
        Text,
        nullable=False,
    )
    ...
    public_title: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
    )
    ...
    x_url: Mapped[str | None] = mapped_column(
        String(500),
        nullable=True,
    )
